                    ...
                    <div class="signup_wrap">
                        ...
                        <div class="col-md-6 col-sm-6">
                            ...
                            <a href="#" class="btn btn-block facebook-btn"><i class="fa fa-facebook-square"
                                ...
                                Facebook</a> <a href="#" class="btn btn-block twitter-btn"><i
                                    class="fa fa-twitter-square" aria-hidden="true"></i> Login with Twitter</a> <a
                                href="#" class="btn btn-block googleplus-btn"><i class="fa fa-google-plus-square"
                                                                                 aria-hidden="true"></i> Login with
                                Google+</a></div>
